...
request/response DTO, общий ответ-конверт ошибки, коды статусов 4xx для каждого
...
- **Этап 11 — документация.** *Готово.* Внутренняя документация (README и
  ...
  (конверт ошибки, file-picker, коды статусов 4xx для каждого эндпоинта) и руководство
