 ...
 * broadcasts via {@link RealtimeEventsPort.emitToRoom}; host/team/captain-scoped
 * delivery and originating-socket snapshots are 5.2b. The constants are the
 * canonical strings from the event catalog — kept here (not in the transport
 * module) so the application layer stays free of transport imports.
 */
